...
$string['visibleforprofileerrorrule'] = 'Visible for profile rule must be consist of two parts separated by a colon, e.g. email:.*@example.org';
$string['visibleforprofileerrorregex'] = 'Visible for profile must be a valid regular expression';
$string['visibleforprofileinfo'] = 'Visible for profiles matching expression (e.g. email:.*@example.org)';
